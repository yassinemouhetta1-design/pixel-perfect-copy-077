      ...
      <header className="relative overflow-hidden hero-gradient">
        ...
        <div className="relative mx-auto grid w-full max-w-[1240px] grid-cols-1 gap-10 px-5 pb-24 pt-10 md:px-8 md:pb-32 md:pt-14 lg:grid-cols-[1.05fr_1fr] lg:gap-6">
          <div className="animate-fade-up">
            ...
            <h1 className="mt-7 text-[44px] font-extrabold leading-[1.05] tracking-tight text-[#0b1437] md:text-[64px]">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.55fr_1fr]">
          ...
          <Card tone="blue" className="relative overflow-hidden p-8 md:p-10">
            ...
            <img
              ...
              width={816}
              height={816}
              className="pointer-events-none absolute -bottom-2 -right-6 h-[170px] w-auto animate-float-slow opacity-95"
            />
          </Card>
        </div>
      </Section>
